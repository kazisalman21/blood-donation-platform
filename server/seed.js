...
const buildDonors = async () => {
    ...
    return [
        ...
        // === ADDITIONAL DONORS FOR MAP DENSITY ===
        {
            name: 'Nazmul Haque',
        ...
        },
        {
            ...
            donationCount: 6,
            badges: ['First Donation', 'Lifesaver', '5 Donations'],
            lastDonationDate: daysAgo(75),
            nextEligibleDate: daysAgo(-19)
        },
        {
            name: 'Priya Barua',
            email: 'priya.barua@gmail.com',
            password: pw,
            bloodType: 'AB-',
            city: 'Dhaka',
            area: 'Badda',
        ...
        },
        {
            ...
            email: 'jubayer.hossain@gmail.com',
            password: pw,
            bloodType: 'A+',
            city: 'Dhaka',
            area: 'Rampura',
